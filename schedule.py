...
BASE_WORKERS = {
    ...
    'Joseba 1': ['dibujo'],
    'Irene': ['pedidos'],
    'Mikel': ['montar', 'montar 2º', 'soldar 2º', 'soldadura interior'],
    'Iban': ['montar', 'montar 2º', 'soldar 2º', 'soldadura interior'],
    'Joseba 2': ['montar', 'montar 2º', 'soldar 2º', 'soldadura interior'],
    'Naparra': ['montar', 'montar 2º', 'soldar 2º', 'soldadura interior'],
    'Unai': ['montar', 'montar 2º', 'soldar 2º', 'soldadura interior'],
    'Fabio': ['soldar 2º', 'soldadura interior'],
    'Beltxa': ['soldar 2º', 'soldadura interior', 'montar', 'montar 2º'],
    'Igor': ['soldar 2º', 'soldadura interior'],
    'Albi': ['recepcionar material', 'soldar 2º', 'soldadura interior', 'montar', 'montar 2º'],
    'Eneko': ['pintar', 'montar', 'montar 2º', 'soldar 2º', 'soldadura interior'],
}
