...
BASE_WORKERS = {
    ...
    'Joseba 1': ['dibujo'],
    'Irene': ['pedidos'],
    'Mikel': ['montar', 'montaje final', 'soldar 2º', 'soldadura interior'],
    'Iban': ['montar', 'montaje final', 'soldar 2º', 'soldadura interior'],
    'Joseba 2': ['montar', 'montaje final', 'soldar 2º', 'soldadura interior'],
    'Naparra': ['montar', 'montaje final', 'soldar 2º', 'soldadura interior'],
    'Unai': ['montar', 'montaje final', 'soldar 2º', 'soldadura interior'],
    'Fabio': ['soldar 2º', 'soldadura interior'],
    'Beltxa': ['soldar 2º', 'soldadura interior', 'montar', 'montaje final'],
    'Igor': ['soldar 2º', 'soldadura interior'],
    'Albi': ['recepcionar material', 'soldar 2º', 'soldadura interior', 'montar', 'montaje final'],
    'Eneko': ['pintar', 'montar', 'montaje final', 'soldar 2º', 'soldadura interior'],
}
